...
const InstituteNavbar = ({ dictionary }: InstituteNavbarProps) => {
  return (
    <Group justifyContent="start" preventGrowOverflow={false} flexGrow flexWrap="nowrap" height="navbar" className="border-t border-border-separator">
      ...
      <Group justifyContent="start" preventGrowOverflow={false}>
        <InstituteNavbarItemButton icon={<Icons iconName="bookmark" />} />
        <InstituteNavbarItemButton icon={<Icons iconName="share" />} />
      </Group>
    </Group>
  );
};

export { InstituteNavbar };
